...
{
     id  _persistenceSurvivingReboot;
     id  _persistenceSurvivingRelaunch;
}

+ (id)persistenceWithPersistenceSurvivingReboot:(id)arg1 persistenceSurvivingRelaunch:(id)arg2;

@property(readonly, nonatomic)  id  persistenceSurvivingRelaunch; // @synthesize persistenceSurvivingRelaunch=_persistenceSurvivingRelaunch;
@property(readonly, nonatomic)  id  persistenceSurvivingReboot; // @synthesize persistenceSurvivingReboot=_persistenceSurvivingReboot;
