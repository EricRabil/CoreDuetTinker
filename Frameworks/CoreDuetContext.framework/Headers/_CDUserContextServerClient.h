...
- (void)_valuesForPaths:(id)arg1 handler:(id)arg2;
- (void)valuesForPaths:(id)arg1 handler:(id)arg2;
- (void)valuesForPaths:(id)arg1 inContextsMatching:(id)arg2 handler:(id)arg3;
- (void)removeObjects:(id)arg1 fromArrayAtPath:(id)arg2 handler:(id)arg3;
- (void)addObjects:(id)arg1 toArrayAtPath:(id)arg2 handler:(id)arg3;
- (void)addObjects:(id)arg1 andRemoveObjects:(id)arg2 forArrayAtPath:(id)arg3 handler:(id)arg4;
...
- (void)fetchPropertiesOfRemoteKeyPaths:(id)arg1 remoteUserContextProxySourceDeviceUUID:(id)arg2 handler:(id)arg3;
- (void)fetchPropertiesOfRemoteKeyPaths:(id)arg1 handler:(id)arg2;
...
- (void)setObject:(id)arg1 lastModifiedDate:(id)arg2 forContextualKeyPath:(id)arg3 handler:(id)arg4;
...
- (void)_valueForRemotePath:(id)arg1 handler:(id)arg2;
- (void)_propertiesOfRemotePath:(id)arg1 handler:(id)arg2;
- (void)propertiesOfRemotePath:(id)arg1 handler:(id)arg2;
- (void)_valueForPath:(id)arg1 handler:(id)arg2;
- (void)_propertiesOfPath:(id)arg1 handler:(id)arg2;
- (void)propertiesOfPath:(id)arg1 handler:(id)arg2;
- (void)_hasKnowledgeOfPath:(id)arg1 handler:(id)arg2;
