...
@interface _DKSync3Coordinator : _DKSync2Coordinator <_DKSyncRemoteContextStorageDelegate, _CDRemoteUserContextServer>
{
    ...
    NSObject<OS_os_transaction> *_watchingDevicesTransaction;
     id  _transportMDCSRapport;
}


@property(retain, nonatomic)  id  transportMDCSRapport; // @synthesize transportMDCSRapport=_transportMDCSRapport;
...
- (void)_requestActivateDevicesWithHandler:(id)arg1;
- (void)requestActivateDevicesWithHandler:(id)arg1;
- (void)_fetchPropertiesOfRemoteKeyPaths:(id)arg1 handler:(id)arg2;
...
- (void)subscribeToDeviceStatusChangeNotificationsForDeviceTypes:(unsigned long long)arg1 handler:(id)arg2;
- (void)unsubscribeFromContextValueChangeNotificationsWithRegistration:(id)arg1 deviceIDs:(id)arg2 handler:(id)arg3;
- (void)subscribeToContextValueChangeNotificationsWithRegistration:(id)arg1 deviceIDs:(id)arg2 handler:(id)arg3;
- (id)sourceDeviceUUID;
