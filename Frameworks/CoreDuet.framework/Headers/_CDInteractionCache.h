...
@property(readonly, nonatomic) id filterBlock; // @synthesize filterBlock=_filterBlock;
...
- (void)_refetch;
- (void)refetch;
- (id)initWithInteractionStore:(id)arg1 size:(unsigned long long)arg2 queryPredicate:(id)arg3 filterBlock:(id)arg4;
