...
@property(copy) id responseHandler; // @synthesize responseHandler=_responseHandler;
...
- (id)startDataTaskWithURI:(id)arg1 headers:(id)arg2 timeoutInterval:(double)arg3 responseHandler:(id)arg4;
- (id)startDownloadTaskWithURI:(id)arg1 headers:(id)arg2 timeoutInterval:(double)arg3 responseHandler:(id)arg4;
