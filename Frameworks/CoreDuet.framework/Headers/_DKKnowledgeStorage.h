...
- (void)startSyncUpToCloudWithResponseQueue:(id)arg1 withCompletion:(id)arg2;
- (void)startSyncDownFromCloudWithResponseQueue:(id)arg1 withCompletion:(id)arg2;
...
- (void)saveHistogram:(id)arg1 responseQueue:(id)arg2 withCompletion:(id)arg3;
