...
- (void)__performSyncWithPolicy:(id)arg1 isTriggeredSync:(BOOL)arg2 localChangeSets:(id)arg3 reply:(id)arg4;
- (void)_performSyncWithPolicy:(id)arg1 isTriggeredSync:(BOOL)arg2 localChangeSets:(id)arg3 reply:(id)arg4;
- (void)performSyncWithPolicy:(id)arg1 reply:(id)arg2;
