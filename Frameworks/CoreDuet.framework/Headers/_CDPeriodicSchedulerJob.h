...
+ (id)jobWithInterval:(double)arg1 schedulerJobName:(id)arg2 queue:(id)arg3 asynchronousHandler:(BOOL)arg4 handler:(id)arg5;
+ (id)jobWithInterval:(double)arg1 schedulerJobName:(id)arg2 handler:(id)arg3;
...
- (id)initWithPeriod:(long long)arg1 interval:(double)arg2 schedulerJobName:(id)arg3 queue:(id)arg4 asynchronousHandler:(BOOL)arg5 handler:(id)arg6;
- (id)init;
