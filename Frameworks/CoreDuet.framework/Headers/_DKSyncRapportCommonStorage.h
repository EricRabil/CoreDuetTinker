...
- (void)handleAvailabilityFailureWithPeer:(id)arg1 completion:(id)arg2;
...
- (void)sendRequestID:(id)arg1 request:(id)arg2 peer:(id)arg3 client:(id)arg4 options:(id)arg5 responseHandler:(id)arg6;
- (void)sendRequestID:(id)arg1 request:(id)arg2 peer:(id)arg3 highPriority:(BOOL)arg4 options:(id)arg5 responseHandler:(id)arg6;
- (id)deviceForPeer:(id)arg1;
- (BOOL)isTransportActiveForPeer:(id)arg1;
- (void)handleFetchSourceDeviceIDWithResponse:(id)arg1 options:(id)arg2 error:(id)arg3 peer:(id)arg4 plStartDate:(id)arg5 completion:(id)arg6;
- (void)handleFetchSourceDeviceIDWithRequest:(id)arg1 options:(id)arg2 responseHandler:(id)arg3;
- (void)fetchSourceDeviceIDFromPeer:(id)arg1 highPriority:(BOOL)arg2 completion:(id)arg3;
- (void)handleBeaconWithResponse:(id)arg1 options:(id)arg2 error:(id)arg3 peer:(id)arg4 completion:(id)arg5;
- (void)handleBeaconWithRequest:(id)arg1 options:(id)arg2 responseHandler:(id)arg3;
- (void)sendBeaconToPeer:(id)arg1 completion:(id)arg2;
- (id)client;
