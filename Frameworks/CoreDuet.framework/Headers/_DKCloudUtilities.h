...
- (void)_performUpdateNumberOfSyncedDevicesWithAttempt:(unsigned long long)arg1 completionHandler:(id)arg2;
- (void)_performUpdateNumberOfSyncedDevicesWithCompletionHandler:(id)arg1;
- (void)_updateNumberOfSyncedDevicesWithCompletionHandler:(id)arg1;
- (void)deleteRemoteStateWithReply:(id)arg1;
- (void)_updateAccountInfo:(id)arg1 error:(id)arg2;
- (void)_fetchAccountInfoWithCompletionHandler:(id)arg1;
