...
@interface _DKSync2Coordinator : _DKSyncContextObject <APSConnectionDelegate, _DKKnowledgeStorageEventNotificationDelegate, _DKSyncRemoteKnowledgeStorageFetchDelegate, _DKSyncCoordinator>
{
    ...
    _DKKnowledgeStorage *_storage;
     id  _keyValueStore;
     id  _localStorage;
     id  _transportCloudDown;
     id  _transportCloudUp;
     id  _transportRapport;
}
...
@property(retain, nonatomic)  id  transportRapport; // @synthesize transportRapport=_transportRapport;
@property(retain, nonatomic)  id  transportCloudUp; // @synthesize transportCloudUp=_transportCloudUp;
@property(retain, nonatomic)  id  transportCloudDown; // @synthesize transportCloudDown=_transportCloudDown;
@property(retain, nonatomic)  id  localStorage; // @synthesize localStorage=_localStorage;
@property(nonatomic) BOOL hasSyncedUpHistoryToCloud; // @synthesize hasSyncedUpHistoryToCloud=_hasSyncedUpHistoryToCloud;
@property(retain, nonatomic)  id  keyValueStore; // @synthesize keyValueStore=_keyValueStore;
...
- (void)__finishSyncWithTransaction:(id)arg1 startDate:(id)arg2 completion:(id)arg3;
- (void)__performSyncWithCompletion:(id)arg1;
- (void)_performSyncWithSyncType:(id)arg1 completion:(id)arg2;
- (void)_synchronizeWithUrgency:(unsigned long long)arg1 client:(id)arg2 completion:(id)arg3;
- (void)_performSyncWithForceSync:(BOOL)arg1 completion:(id)arg2;
- (void)deleteRemoteStateWithReply:(id)arg1;
- (void)synchronizeWithUrgency:(unsigned long long)arg1 client:(id)arg2 reply:(id)arg3;
- (void)syncWithReply:(id)arg1;
