...
- (void)deleteKnowledgeEventsMatchingPredicate:(id)arg1 withCompletion:(id)arg2;
- (void)_deleteKnowledgeEventsMatchingPredicate:(id)arg1;
- (void)deleteAllItemsWithBundleID:(id)arg1 completion:(id)arg2;
- (void)deleteInteractionsWithGroupIdentifiers:(id)arg1 bundleID:(id)arg2 protectionClass:(id)arg3 withCompletion:(id)arg4;
- (void)deleteInteractionsWithGroupIdentifiers:(id)arg1 bundleID:(id)arg2 protectionClass:(id)arg3;
- (void)deleteAllInteractionsWithBundleID:(id)arg1 protectionClass:(id)arg2 withCompletion:(id)arg3;
- (void)deleteAllInteractionsWithBundleID:(id)arg1 protectionClass:(id)arg2;
- (void)deleteInteractionsWithIdentifiers:(id)arg1 bundleID:(id)arg2 protectionClass:(id)arg3 withCompletion:(id)arg4;
- (void)deleteInteractionsWithIdentifiers:(id)arg1 bundleID:(id)arg2 protectionClass:(id)arg3;
- (void)deleteSearchableItemsSinceDate:(id)arg1 bundleID:(id)arg2 withCompletion:(id)arg3;
- (void)deleteSearchableItemsSinceDate:(id)arg1 bundleID:(id)arg2;
- (void)deleteSearchableItemsWithIdentifiers:(id)arg1 bundleID:(id)arg2 withCompletion:(id)arg3;
- (void)deleteSearchableItemsWithIdentifiers:(id)arg1 bundleID:(id)arg2;
- (void)deleteAllSearchableItemsWithBundleID:(id)arg1 withCompletion:(id)arg2;
- (void)deleteAllSearchableItemsWithBundleID:(id)arg1;
- (void)deleteSearchableItemsWithDomainIdentifiers:(id)arg1 bundleID:(id)arg2 withCompletion:(id)arg3;
...
- (void)addUserAction:(id)arg1 withItem:(id)arg2 withCompletion:(id)arg3;
- (void)addUserAction:(id)arg1 withItem:(id)arg2;
- (void)addOrUpdateSearchableItems:(id)arg1 bundleID:(id)arg2 withCompletion:(id)arg3;
- (void)addOrUpdateSearchableItems:(id)arg1 bundleID:(id)arg2;
- (void)addInteractions:(id)arg1 bundleID:(id)arg2 protectionClass:(id)arg3 withCompletion:(id)arg4;
...
- (void)saveRateLimitedEvents:(id)arg1 responseQueue:(id)arg2 withCompletion:(id)arg3;
